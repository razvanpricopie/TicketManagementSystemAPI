...
namespace TicketManagementSystemAPI.Persistence.Migrations
{
    ...
    [Migration("20240412103724_ChangeImageTyptToBlob")]
    partial class ChangeImageTyptToBlob
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketManagementSystemAPI.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2024, 10, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8113),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 1, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8194),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2024, 8, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8205),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2024, 8, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8216),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 2, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8226),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2024, 12, 12, 13, 37, 23, 969, DateTimeKind.Local).AddTicks(8236),
