...
using TicketManagementSystemAPI.Identity.Services;
    ...
    public static class IdentityServiceExtensions
    {
        public static void AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<TicketManagementSystemIdentityDbContext>(options =>
                options.UseSqlServer(configuration.GetConnectionString("TicketManagementSystemConnectionString"), b => b.MigrationsAssembly(typeof(TicketManagementSystemIdentityDbContext).Assembly.FullName)));

            services.AddIdentity<ApplicationUser, IdentityRole>(options => options.SignIn.RequireConfirmedEmail = false)
                .AddRoles<IdentityRole>()
                .AddEntityFrameworkStores<TicketManagementSystemIdentityDbContext>().AddDefaultTokenProviders();
